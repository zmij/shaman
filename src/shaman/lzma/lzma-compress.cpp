/**
 * @file lzma-compress.cpp
 * Test program to demonstrate LZMA decompression using shaman::lzma::lzma_compressor.
 * Takes one argument - file name, compresses it and writes result to standard
 * output
